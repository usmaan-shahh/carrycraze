...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const serviceId = "service_1r1qf33"; // You'll need to create this in EmailJS
      const templateId = "template_738y9lg"; // You'll need to create this in EmailJS
      const publicKey = "b89xF8Uq4rFjm_sSv"; // You'll get this from EmailJS
      ...
      const templateParams = {
        ...
        to_email: "carry.craze@rediffmail.com",
      };
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            ...
            products, services, or anything else, our team is ready to assist
            you.
          </p>
        </motion.div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="flex-shrink-0 bg-blue-100 rounded-full p-3 text-blue-600 mr-4">
                    <svg
          ...
          >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <button
                    ...
                    className={`w-full font-medium py-3 px-4 rounded-md shadow-md transition-colors duration-300 flex items-center justify-center ${
                      isSubmitting
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="rounded-lg overflow-hidden h-[300px] relative">
                {/* Placeholder for map - in a real implementation, you'd use Google Maps or another service */}
                ...
                {/* You would typically include an iframe with Google Maps here */}
              </div>
            </div>
          </motion.div>
        </div>
