            ...
            <div className="bg-white p-8 rounded-lg shadow-lg mb-8">
              ...
              <form className="space-y-6">
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-md shadow-md transition-colors duration-300 flex items-center justify-center"
                  >
